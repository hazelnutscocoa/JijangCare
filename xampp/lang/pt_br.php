...
$TEXT['security-checkftppassword-nok']="A senha do servidor de FTP FileZilla permanece ainda como 'xampp'";
...
$TEXT['start-head-osx']="Bem vindo ao XAMPP para OS X";
...
<li><a href=http://dev.mysql.com/doc/refman/5.1/en/index.html>Documentação do MySQL</a>
...
$TEXT['components-text3']="No diretório <b>/Applications/XAMPP/xamppfiles/licenses</b> você irá encontrar todas as licenças e arquivos README destes programas.";
...
$TEXT['cds-text2']="Lista de CD's como um <a href='?action=getpdf'>Arquivo PDF</a>.";
