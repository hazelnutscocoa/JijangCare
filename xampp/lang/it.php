...
$TEXT['global-xampp-osx']="XAMPP per OS X";
...
$TEXT['status-opcache']="Estensioni PHP &#187;OPcache&#171;";
...
$TEXT['security-checkftppassword-nok']="La password FTP per l'utente daemon è ancora 'xampp'";
$TEXT['security-checkftppassword-ok']="La password FTP per l'utente daemon è stata cambiata";
$TEXT['security-checkftppassword-text']="Usando la password di default per l'utente 'daemon' chiunque può caricare o modificare files del webserver Xampp. E' consigliabile cambiare password.";
...
$TEXT['start-head-osx']="Benvenuto in XAMPP per OS X";
...
$TEXT['components-text3']="Nella cartella <b>/Applications/XAMPP/xamppfiles/licenses</b> troverai le licenze e i README files di questi programmi.";
