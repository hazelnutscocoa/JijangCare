...
$TEXT['status-opcache']="PHP tilleggspakke &#187;OPcache&#171;";
...
$TEXT['security-text2']="Det grønnmerkede området er sikkert; det rødmerkede området er usikkert og gulmerkede området er statusen ukjent for (for eksempel applikasjonen kjører ikke).<p>To fix or close all these matters simply call<p><b>/Applications/XAMPP/xamppfiles/xampp security</b><p>This will start an interactive program.";
...
$TEXT['security-checkpmamysqlbruker-ytext']="phpMyAdmin lagrer dine inntillinger i en ekstra MySQL database. For å få tilgang til denne dataen bruk phpMyAdmin og superbrukeren pma. Denne brukeren har i standard installasjonen ikke noen passord satt, og for å unngå et sikkerhetsproblem burde du gi Vedkommende et passord.";
...
$TEXT['security-checkftppassword-nok']="FTP passordet er forsatt 'xampp'";
...
$TEXT['security-checkftppassword-text']="Hvis FTP serveren var startet, standardbrukeren 'daemon' med passordet  'lampp' kan laste opp å endre filer på XAMPP webserveren.";
...
$TEXT['start-head-osx']="Velkommen til XAMPP for OS X";
...
$TEXT['manuals-list1']="
<ul>
<li><a href=http://httpd.apache.org/docs/2.4/>Apache 2 dokumentasjon</a>
<li><a href=http://www.php.net/manual/en/>PHP <b>referenz </b>dokumentasjon</a>
<li><a href=http://perldoc.perl.org/index.html>Perl dokumentasjon</a>
<li><a href=http://dev.mysql.com/doc/refman/5.5/en/>MySQL dokumentasjon</a>
<li><a href=http://php.weblogs.com/ADODB>ADODB</a>
<li><a href=http://eaccelerator.net/>eAccelerator for PHP</a>
<li><a href=http://pdf-php.sourceforge.net/index.php/documentation.html>pdf class dokumentasjon</a>
</ul>";
...
$TEXT['components-text3']="I katalogen <b>/Applications/XAMPP/xamppfiles/licenses</b> vil du finne alle lisens informasjonen for disse programmene.";
...
$TEXT['cds-text2']="CD listen er <a href='?action=getpdf'>PDF dokument</a>.";
