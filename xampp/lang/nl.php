...
$TEXT['global-xampp-osx']="XAMPP voor OS X";
...
$TEXT['security-text2']="De groen gemarkeerde punten zijn veilig; de rood gemarkeerde punten zijn absoluut onveilig en de geel gemarkeerde punten konden niet gecontroleerd worden (bv. omdat de software tbv de controle niet draait).<p>Om deze zaken op te lossen, of af te sluiten: voer het volgende commande uit <p><b>/Applications/XAMPP/xamppfiles/xampp security</b><p>Dit start een interactief  programma.";
...
$TEXT['security-checkftpwachtwoord-nok']="Het FTP wachtwoord voor gebruiker daemon is 'lampp'";
$TEXT['security-checkftpwachtwoord-ok']="Het FTP wachtwoord voor gebruiker daemon is niet langer 'lampp'";
$TEXT['security-checkftpwachtwoord-text']="Door gebruik te maken van het standaard wachtwoord voor de FTP gebruiker daemon, kan iedereen bestanden voor uw XAMPP webserver uploaden en wijzigen. Dus als u ProFTPD activeert, moet u een nieuw wachtwoord instellen voor de gebruiker daemon.";
...
$TEXT['start-head-osx']="Welkom bij XAMPP voor OS X";
...
$TEXT['manuals-list1']="
<ul>
<li><a href=http://httpd.apache.org/docs/2.4/>Apache 2 documentatie</a>
<li><a href=http://www.php.net/manual/en/>PHP <b>referenz </b>documentatie</a>
<li><a href=http://perldoc.perl.org/index.html>Perl documentatie</a>
<li><a href=http://dev.mysql.com/doc/refman/5.5/en/>MySQL documentatie</a>
<li><a href=http://www.proftpd.org/docs/>ProFTPD gebruikershandleiding</a>
<li><a href=http://pdf-php.sourceforge.net/index.php/documentation.html>pdf class documentatie</a>
</ul>";
...
$TEXT['components-text3']="In de directory <b>/Applications/XAMPP/xamppfiles/licenses</b> vindt u alle licenties en README bestanden van deze programma's.";
...
$TEXT['cds-text2']="CD lijst als <a href='?action=getpdf'>PDF document</a>.";
