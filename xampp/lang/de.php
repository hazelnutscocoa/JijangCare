...
$TEXT['global-xampp-osx']="XAMPP für OS X";
...
$TEXT['status-opcache']="PHP-Erweiterung &#187;OPcache&#171;";
...
$TEXT['security-checkftppassword-nok']="Das FTP-Passwort ist noch immer 'xampp'";
$TEXT['security-checkftppassword-ok']="Das FTP-Passwort wurde geändert";
$TEXT['security-checkftppassword-text']="Wenn Du ProFTPD im XAMPP aktiviert hast, dann kannst Du standardmäßig mit dem Benutzernamen 'daemon' und dem Passwort 'lampp' Dateien für Deinen Webserver hochladen. Potentiell kann das nun natürlich jeder und daher sollte hier unbeding ein anderes Passwort gesetzt werden.";
...
$TEXT['start-head']="Willkommen zu XAMPP für OS X";
...
$TEXT['manuals-list1']="
<ul>
<li><a href=http://httpd.apache.org/docs/2.4/>Apache 2 Dokumentation (in Englisch)</a>
<li><a href=http://www.php.net/manual/de/>PHP <b>Referenz-</b>Dokumentation (in Deutsch)</a>
<li><a href=http://perldoc.perl.org/index.html>Perl Dokumentation (in Englisch)</a>
<li><a href=http://dev.mysql.com/doc/refman/5.1/de/index.html>MySQL Dokumentation (in Deutsch)</a>
<li><a href=http://www.proftpd.org/docs/>ProFTPD (in Englisch)</a>
<li><a href=http://pdf-php.sourceforge.net/index.php/documentation.html>pdf class Dokumentation</a>
</ul>";
...
$TEXT['components-text3']="Im Verzeichnis <b>/Applications/XAMPP/xamppfiles/licenses</b> befinden sich die einzelnen Lizenz-Texte und README-Dateien dieser Pakete.";
...
$TEXT['cds-text2']="<b>Neu seit 0.9.6:</b> Ausgabe der eingestellten CDs als <a href='?action=getpdf'>PDF-Dokument</a>.";
