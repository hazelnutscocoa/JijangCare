...
$TEXT['global-xampp-osx']="XAMPP pour OS X";
...
$TEXT['security-text2']="Les points marqués en verts sont securisés; les points marqués en rouge sont définitivement insécurisés et les points marqués en jaune n'ont pas pu être vérifiés (ex: parce que le logiciel de vérification n'est pas lancé).<p>Pour réparer ou fermer tous ces objets appelez simplement <p><b>/Applications/XAMPP/xamppfiles/xampp security</b><p>Ceci démarrera un programme intéractif.";
...
$TEXT['security-checkftppassword-nok']="Le mot de passe pour l'utilisateur FTP daemon est toujours 'xampp'";
$TEXT['security-checkftppassword-ok']="Le mot de passe pour l'utilisateur FTP daemon n'est plus 'xampp'";
$TEXT['security-checkftppassword-text']="En utilisant le mot de passe par défaut pour l'utilisateur FTP 'daemon', tout le monde peut uploader et changer des fichiers de votre serveur XAMPP.";
...
$TEXT['start-head-osx']="Bienvenue dans XAMPP pour OS X";
...
$TEXT['manuals-list1']="
<ul>
<li><a href=http://httpd.apache.org/docs/2.4/>Documentation Apache 2</a>
<li><a href=http://www.php.net/manual/en/>Documentation de <b>référence </b>PHP</a>
<li><a href=http://perldoc.perl.org/index.html>Documentation Perl </a>
<li><a href=http://dev.mysql.com/doc/refman/5.5/en/>Documentation MySQL</a>
<li><a href=http://pdf-php.sourceforge.net/index.php/documentation.html>Documentation class pdf </a>
</ul>";
...
$TEXT['components-text3']="Dans le répertoire <b>/Applications/XAMPP/xamppfiles/licenses</b> vous trouverez toutes les licences de ces programmes.";
...
$TEXT['cds-text2']="Liste de CD en temps que document <a href='?action=getpdf'>PDF</a>.";
