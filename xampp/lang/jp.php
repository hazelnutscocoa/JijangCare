...
$TEXT['global-xampp-osx']="XAMPP OS X版";
...
$TEXT['security-text2']="緑のハイライトの表示は「安全」です。赤のハイライトの表示は、決定的に「要注意」、黄色のハイライトは「確認不能」(例えば、確認したいソフトウェアが稼動していないなど)です。<p>そのような問題をすべて修正するには、単純に<p><b>/Applications/XAMPP/xamppfiles/xampp security</b><p>をコールしてください。インタラクティブなプログラムが開始されます。";
...
$TEXT['security-checkftppassword-nok']="ユーザdaemon のFTPパスワードが「xampp」のままです";
$TEXT['security-checkftppassword-ok']="ユーザdaemon のFTPパスワードが「xampp」から変更されました";
...
$TEXT['start-head-osx']="XAMPP OS X版へようこそ";
...
$TEXT['manuals-list1']="
<ul>
<li><a href=http://httpd.apache.org/docs/2.4/>Apache 2 ドキュメント</a>
<li><a href=http://www.php.net/manual/en/>PHP <b>リファレンス </b>ドキュメント</a>
<li><a href=http://perldoc.perl.org/index.html>Perl ドキュメント</a>
<li><a href=http://dev.mysql.com/doc/refman/5.5/en/>MySQL ドキュメント</a>
<li><a href=http://www.proftpd.org/docs/>ProFTPD ユーザガイド</a>
<li><a href=http://pdf-php.sourceforge.net/index.php/documentation.html>pdf class ドキュメント</a>
</ul>";
...
$TEXT['components-text3']="In the directory <b>/Applications/XAMPP/xamppfiles/licenses</b> you will find all licenses and README files of these programs.";
...
$TEXT['cds-text2']="CDリスト<a href='?action=getpdf'>PDF ドキュメント</a>.";
