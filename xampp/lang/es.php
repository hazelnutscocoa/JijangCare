...
$TEXT['global-xampp-osx']="XAMPP para OS X";
...
$TEXT['security-checkftppassword-nok']="La contraseña del usuario FTP daemon todavia es 'xampp'";
$TEXT['security-checkftppassword-ok']="La contraseña del usuario FTP daemon ya no es 'xampp'";
$TEXT['security-checkftppassword-text']="Usando la contraseña por defecto para el usuario FTP daemon cualquiera puede subir y cambiar ficheros en tu servidor web XAMPP. Si activas ProFTPD debes poner una nueva contraseña al usuario daemon.";
// ---------------------------------------------------------------------
// START
// ---------------------------------------------------------------------
...
$TEXT['start-head-osx']="Bienvenido a XAMPP para OS X";
...
<li><a href=http://www.proftpd.org/docs/>ProFTPD user guide</a>
...
$TEXT['components-text3']="En el directorio <b>/Applications/XAMPP/xamppfiles/licenses</b> encontraras todas las licencias y ficheros README de estos programas.";
