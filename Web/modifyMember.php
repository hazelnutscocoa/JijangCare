<?php
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($passwordError == "" && $emailError == "" ){
      if
    (mysqli_query($con, "UPDATE `Member` SET `password` = '$password', `email` = '$email', `fullname` = '$fullname', `level` = '$level' WHERE `username` = '".$username."'"));
        {
...
<div class="container">
  ...
  <div class="row">
      ...
      <div class="col-md-9 personal-info">
        ...
        <form action="modifyMember.php" method="POST" class="form-horizontal" role="form">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="email" name="email" placeholder="<?php if(isset($emailError)){echo $emailError;} ?>">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <select class="col-lg-3 control-label" id="level" name="level">
