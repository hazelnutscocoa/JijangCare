...
abstract class ET_Engine{
	...
	public function master_init(){
		...
		$base_scripts = array(
			'modernizr'	=> array(
				'src'		=> "$http://cdnjs.cloudflare.com/ajax/libs/modernizr/2.5.3/modernizr.min.js",
				'fallback'	=> FRAMEWORK_URL . '/js/lib/modernizr.min.js'
				),
			// 'jquery'	=> array(
			// 	'src'		=> 'https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js',
			// 	'fallback'	=> FRAMEWORK_URL . '/js/lib/jquery.min.js'
			// 	),
			'et_underscore'	=> array(
	...
	public function master_print_scripts(){
		...
		// 	$this->enqueue_scripts((array)$this->scripts);
		// }
