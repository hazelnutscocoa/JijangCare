...
//  */
// class ET_Plugin_Updater extends ET_Update{
// 	public function __construct($current_version, $update_path, $product_slug){
// 		parent::__construct($current_version, $update_path, $product_slug);
...
// 	 * @return string $remote_version
// 	 */
// 	public function get_remote_infomation()
// 	{
// 		$request = wp_remote_post($this->update_path, array('body' => array('action' => 'info', 'product' => $this->product_slug)));
 ...
 */
class ET_Menu_Update extends ET_Base{
...
function et_check_update(){
	...
	$update_path = ET_UPDATE_PATH . '&product=jobengine&type=theme';
	new ET_Theme_Updater(ET_VERSION, $update_path, 'jobengine', 'http://enginethemes.com');
	// add menu update
	new ET_Menu_Update();
