...
<div id="step-2" class="form-signup" <?php if(!is_singular('resume') ) echo 'style="display:none;"' ; ?> >
	...
	<!-- <div class="content-info content-text content-timeline">
    	<span class="icon icon-edit" data-icon="p"></span>
		<h1 class="line">EDUCATION</h1>
		<?php for ($i = 0; $i < 2 ; $i ++ ) { ?>
			<div class="line-stand">
            	<span class="icon icon-track" data-icon="#"></span>
				<span class="dotted"></span>
				<div class="intro">
					<span class="year"><?php echo 'month'. ($i + 1) ?> - <?php echo 'year'. ($i + 1) ?></span><br />
					<span class="name"><?php echo 'name'. ($i + 1) ?></span>
				</div>
			</div>
		<?php } ?>
	</div> -->
	...
	<div class="content-info content-text content-timeline et_education" data-resume="et_education"  >
        ...
        <!-- <div class="input-text-remind btn-signup-save">
	...
	<!-- <div class="content-info content-text content-timeline">
    	<span class="icon icon-edit" data-icon="p"></span>
		<h1 class="line">WORK EXPERIENCE</h1>
		<?php for ($i = 0; $i < 2 ; $i ++ ) { ?>
			<div class="line-stand">
            	<span class="icon icon-track" data-icon="#"></span>
				<span class="dotted"></span>
