<div id="step-1">
	...
	<form id="jobseeker_signup" data-ajax="false" class="form-signup">
		<!-- <div class="content-info content-text" >
			<?php 
				_e("Do you want to import data from your LinkedIn account?", ET_DOMAIN);
			 ?>
				<a id="linkleIn" href="#" data-msg="<?php _e("You have to use jobseeker account to apply job.", ET_DOMAIN); ?>" class="remind ui-btn-s btn-white btn-wide">
					<?php  _e('Load them up',ET_DOMAIN); ?>
				</a>
