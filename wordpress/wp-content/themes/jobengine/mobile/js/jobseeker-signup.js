(function ($) {
	...
	var resume = {
		...
		updateEdu : function () {
			...
			// console.log(view.data.et_education);
		},
		...
		updateExp : function () {
			...
			console.log(view.data.et_experience);
		},
	...
	$(document).on('pageinit' , function () {
		 ...
		 * add jobseeker info
		*/
		// $('#jobseeker_signup input').on('change' , function (e) {
		...
		*/
		$('.add_more_school').on('click' , function (e) {
			...
			if(!validate ) {
				...
				console.log(resume.validate ($container) );
		...
		*/
		...
		$('.icon-track').on('click' , function (event) {
			console.log('a');
			var $target		= $(event.currentTarget);
			$target.parents('.element').remove();
		});	
