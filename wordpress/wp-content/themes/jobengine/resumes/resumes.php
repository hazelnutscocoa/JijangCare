...
class JE_Resume extends ET_Base{
    ...
    static public function insert($args){
        ...
        $args = wp_parse_args( $args, array(
            ...
            'post_status'   => ($pending_resume) ? 'pending' : 'publish',
    ...
    static public function update($args){
        ...
        if($id) {
            ...
            */
            // if(isset($fields['et_privacy']) ) {                
            //     JE_Job_Seeker::update (array('ID' => $resume->post_author , 'et_privacy' => $fields['et_privacy'] ));
            // }
...
class JE_Resume_Ajax extends ET_Base{
    ...
    public function resume_fetch(){
        ...
        while (have_posts()){
            ...
            if (!$user_added){
                ...
                $users[]    = JE_Job_Seeker::convert_from_user($user);
            }
        }
    ...
    **/
    ...
    function et_jobseeker_upload_resume(){
        ...
        * check permision
        */
        $applied =  $wpdb->get_row("SELECT * FROM $wpdb->posts where post_type = 'application' and post_parent = $job_id ");
        if($applied != null){
