...
//require_once RESUME_PATH . '/admin.php';
//require_once RESUME_PATH . '/admin.php';
...
class JE_Resume_Options extends ET_Options {
	...
	function __construct() {
		self::$opt_keys	=	array (
			...
			'et_resumes_status'				=> 0,
			'et_jobseeker_headline'			=> __("<h6>JOBENGINE RESUME</h6> <p>A strong resume help you stand out from the crowd.<br>Learn how to craft one that makes you look your best.</p>", ET_DOMAIN),	
...
// add_action ('after_setup_theme' , 'je_load_resumes');
// function je_load_resumes () {
	//
try {
	if (is_admin()){
		// including
